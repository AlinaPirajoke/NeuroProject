...
st.write("Полносвязная нейронная сеть используется в случае, когда по имеющемуся у вас набору признаков нужно определить какому объекту (классу) они принадлежат. То есть задача нейросети выбрать один из имеющихся вариантов, опираясь на предоставленное ей описание свойств ")
